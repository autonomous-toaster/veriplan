...
Provides the `.pre-commit-hooks.yaml` configuration file for the pre-commit framework, enabling teams to add veriplan as a git pre-commit hook with a single config entry.
