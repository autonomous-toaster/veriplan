...
Parse OpenSpec plan files (tasks.md and specs/**/*.md) into a PlanIR intermediate representation. This is the entry point of the verification pipeline — it runs before convertibility checking.
