...
Provides go-to-definition and hover for task references in spec files, allowing editors to jump from T<N> references to their definitions in tasks.md and show task details on hover.
