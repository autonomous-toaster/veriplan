...
| T ID | Description |
|------|-------------|
| T1.1 | Check scenario step content with the safe STE subset |
| T1.2 | Strip GIVEN/WHEN/THEN/AND markers and code spans from a step |
| T1.3 | Exclude PassiveVoice and OneInstructionPerSentence from scenario checking |
| T2.1 | Report scenario prose findings as rephrase directives |
| T3.1 | Parse scenario steps from a requirement body |
